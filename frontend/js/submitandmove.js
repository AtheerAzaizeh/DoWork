document.addEventListener("DOMContentLoaded", () => {
  ...
  jobForm.addEventListener("submit", async (e) => {
    ...
    // وظيفة لتوليد قيمة عشوائية للراتب
    const generateRandomSalary = () => {
      const min = 30000; // الحد الأدنى للراتب
      const max = 100000; // الحد الأقصى للراتب
    ...
    const jobData = {
      ...
      salary: generateRandomSalary().toString(), // توليد قيمة عشوائية للراتب
